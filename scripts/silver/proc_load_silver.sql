...
=====================================================================
Overview:
    This stored procedure handles the ETL (Extract, Transform, Load)
    workflow to populate tables in the 'silver' schema using data
    sourced from the 'bronze' schema.

Operations:
    - Clears existing data in Silver tables (TRUNCATE)
    - Loads transformed and cleansed data from Bronze into Silver

Parameters:
    None.
    This procedure does not require input parameters and does not
    return any output.
